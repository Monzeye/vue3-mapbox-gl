...
import { useCreateRasterLayer } from '@/hooks/layers/useCreateRasterLayer'
...
const props = withDefaults(
  defineProps<
    LayerProps & {
      register?: (actions: CreateLayerActions<RasterLayer>, map: Map) => any
    }
  >(),
  {
    visible: undefined
...
const emit = defineEmits<{
  ...
  (e: 'register', actions: CreateLayerActions<RasterLayer>, map: Map): any
