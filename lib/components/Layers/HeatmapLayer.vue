...
import { useCreateHeatmapLayer } from '@/hooks/layers/useCreateHeatmapLayer'
...
const props = withDefaults(
  defineProps<
    LayerProps & {
      register?: (actions: CreateLayerActions<HeatmapLayer>, map: Map) => any
    }
  >(),
  {
    visible: undefined
...
const emit = defineEmits<{
  ...
  (e: 'register', actions: CreateLayerActions<HeatmapLayer>, map: Map): any
