...
import { useCreateFillLayer } from '@/hooks/layers/useCreateFillLayer'
...
const props = withDefaults(
  defineProps<
    LayerProps & {
      register?: (actions: CreateLayerActions<FillLayer>, map: Map) => any
    }
  >(),
  {
    visible: undefined
...
const emit = defineEmits<{
  ...
  (e: 'register', actions: CreateLayerActions<FillLayer>, map: Map): any
