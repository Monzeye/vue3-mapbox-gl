...
import { useCreateHillshadeLayer } from '@/hooks/layers/useCreateHillshadeLayer'
...
const props = withDefaults(
  defineProps<
    LayerProps & {
      register?: (actions: CreateLayerActions<HillshadeLayer>, map: Map) => any
    }
  >(),
  {
    visible: undefined
...
const emit = defineEmits<{
  ...
  (e: 'register', actions: CreateLayerActions<HillshadeLayer>, map: Map): any
